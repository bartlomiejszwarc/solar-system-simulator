...
export const sunGeometry = new THREE.SphereGeometry(
  PlanetData.earthRadius * 5,
  64,
  32
);

export const mercuryGeometry = new THREE.SphereGeometry(
...
export const venusGeometry = new THREE.SphereGeometry(
...
export const earthGeometry = new THREE.SphereGeometry(
...
export const marsGeometry = new THREE.SphereGeometry(
...
export const jupiterGeometry = new THREE.SphereGeometry(
...
export const saturnGeometry = new THREE.SphereGeometry(
...
export const uranusGeometry = new THREE.SphereGeometry(
...
export const neptuneGeometry = new THREE.SphereGeometry(
...
export const moonGeometry = new THREE.SphereGeometry(
