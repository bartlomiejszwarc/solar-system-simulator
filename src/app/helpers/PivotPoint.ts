...
mercuryPivotPoint.rotateY(degToRad(AE.EclipticLongitude(AE.Body.Mercury, Date.date)))
mercuryPivotPoint.add(PlanetObject.mercury)

export const venusPivotPoint = new THREE.Group()
venusPivotPoint.rotateY(degToRad(AE.EclipticLongitude(AE.Body.Venus, Date.date)))
venusPivotPoint.add(PlanetObject.venus)

export const earthPivotPoint = new THREE.Group()
earthPivotPoint.rotateY(degToRad(AE.EclipticLongitude(AE.Body.Earth, Date.date)))
...
jupiterPivotPoint.rotateY(degToRad(AE.EclipticLongitude(AE.Body.Jupiter, Date.date)))
jupiterPivotPoint.add(PlanetObject.jupiter)

export const saturnPivotPoint = new THREE.Group()
saturnPivotPoint.rotateY(degToRad(AE.EclipticLongitude(AE.Body.Saturn, Date.date)))
...
uranusPivotPoint.rotateY(degToRad(AE.EclipticLongitude(AE.Body.Uranus, Date.date)))
uranusPivotPoint.add(PlanetObject.uranus)

export const neptunePivotPoint = new THREE.Group()
neptunePivotPoint.rotateY(degToRad(AE.EclipticLongitude(AE.Body.Neptune, Date.date)))
